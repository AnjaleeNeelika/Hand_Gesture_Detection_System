            ...
            <div className='flex-col'>
                <div
                    ...
                    <div className="py-6">
                        ...
                        <div className='text-5xl text-[#7a7a7a]'>
                    ...
                    <div className="py-6">
                        ...
                        <label htmlFor="uploadFile1"
                            className="block px-6 py-2.5 rounded text-gray-600 text-sm tracking-wider font-semibold border-none outline-none bg-gray-200 hover:bg-[#c49a9a67]">Browse Files</label>
